...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url," + prefix + "gitclone" + " https://github.com/HyHamza/BYTE-MD_*");
    }
...
smd({
  ...
  try {
    ...
    await _0x272f8d.bot.sendMessage(_0x272f8d.chat, {
      ...
      caption: "*HERE WE GO*",
      contextInfo: {
        ...(await _0x272f8d.bot.contextInfo("BYTE-MD"+" "+ _0x272f8d.senderName))
      }
    }, {
      quoted: _0x272f8d
    });
...
smd({
  ...
  try {
    ...
    var _0x3048ab = {
      ...(await _0xe5ea97.bot.contextInfo("BYTE-MD"+" "+ "ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ"))
    };
    let _0x3d0cf7 = {
    ...
    try {
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[1] || "BYTE-MD -- YT Video";
      if (_0x3e3caf) {
...
smd({
  ...
  try {
    ...
    var _0x1e7392 = {
      ...(await _0xf4a47.bot.contextInfo("BYTE-MD" +" "+ "ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ"))
    };
    if (_0x2b6ac2) {
...
smd({
  ...
  try {
    ...
    var _0x28302f = {
      ...(await _0x54463e.bot.contextInfo("BYTE-MD"+" "+ "ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ"))
    };
    if (_0x37323e) {
...
smd({
  ...
  try {
    ...
    var _0x29fdd9 = {
      ...(await _0x2ee3dd.bot.contextInfo("BYTE-MD"+" "+ "ᴛɪᴋᴛᴏᴋ ꜱᴏᴜɴᴅ " + _0x19c223))
    };
    let _0x4737bb = {
      audio: _0x2ba501,
      fileName: "BYTE-MD tiktok Sound" + _0x19c223 + ".m4a",
      mimetype: "audio/mpeg",
      ptt: true,
...
smd({
  ...
  try {
    ...
    var _0x2e165b = {
      ...(await _0x1da3da.bot.contextInfo("BYTE-MD"+" "+ "ʀɪɴɢᴛᴏɴᴇ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ"))
    };
    let _0x5c9751 = {
      audio: {
...
smd({
  ...
  try {
    ...
    var _0x132d25 = {
      ...(await _0xf8b0b.bot.contextInfo("BYTE-MD"+" "+ "ᴘɪɴᴛᴇʀᴇꜱᴛ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ"))
    };
...
smd({
  ...
  try {
    ...
    var _0x227c35 = {
      ...(await _0x1ccf8b.bot.contextInfo("BYTE-MD"+" "+ "MEDIAFIRE"))
    };
    let _0x33773c = {
      document: {
...
smd({
  ...
  try {
    ...
    var _0x3b1bff = {
      ...(await _0x1d4717.bot.contextInfo("BYTE-MD"+" "+ "ʏᴛᴅʟ ᴠɪᴅᴇᴏ"))
    };
    let _0x4d676e = {
    ...
    try {
      ...
      var _0x3b1bff = {
        ...(await _0x1d4717.bot.contextInfo("BYTE-MD"+" "+ "ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏ"))
      };
...
smd({
  ...
  try {
    ...
    var _0x29af08 = {
      ...(await _0x3f8930.bot.contextInfo("BYTE-MD"+" "+ "ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏ"))
    };
    let _0x4c646c = {
...
smd({
  ...
  try {
    ...
    var _0x10e2fa = {
      ...(await _0x17c662.bot.contextInfo("BYTE-MD"+" "+ "ʏᴛᴅᴏᴄ ᴍᴘ3 ʏᴏᴜᴛᴜʙᴇ"))
    };
    let _0x300d1a = {
      document: {
        url: _0x59bbaa
      ...
      mimetype: "audio/mpeg",
      fileName: "BYTE-MD--" + _0x1d542b[1] + ".mp3",
      caption: Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("BYTE-MD || SONG DOWNLOADER")) {
    ...
    } else if (_0x5b8ee5[0].includes("BYTE-MD || YOUTUBE DOWNLOADER")) {
