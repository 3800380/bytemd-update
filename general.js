  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/HyHamza/BYTE-MD"
      );
      let _0x1c73f9 = (
        "\n *BYTE-MD simplest Whatsapp BOT*" +
        "*. \n\n  *Stars:* " +
      ...
      if (!_0x14810d) {
        return await _0x165087.reply(
          "*Advertise of your Message*\n*by sending it to provided nmbr range.*\n" +
            prefix +
            "advt 9230723803xx,Your_text_here"
        );
      }
      ...
      if (!_0xd9b857.includes("x")) {
        return _0x165087.send(
          "*You did not add x in number.*\n*Ex: " +
            prefix +
            "advt 9230723803xx,Your_Message_here*  \n " +
            Config.caption
        );
      }
