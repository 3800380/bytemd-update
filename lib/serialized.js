...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = Hamza_grop.decodeJid(Hamza_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let Hamza_bot = {
      ...group_sss,
    };
    Hamza_bot.chat = Hamza_bot.jid = Hamza_bot.from = group_sss.id;
    Hamza_bot.user = Hamza_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    Hamza_bot.name = await Hamza_grop.getName(Hamza_bot.user);
    Hamza_bot.userNum = Hamza_bot.senderNum = Hamza_bot.user.split("@")[0];
    Hamza_bot.time = getTime("h:mm:ss a");
    Hamza_bot.date = getTime("dddd, MMMM Do YYYY");
    Hamza_bot.action = Hamza_bot.status = group_sss.action;
    Hamza_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...
      .includes(Hamza_bot.user);
    Hamza_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(Hamza_bot.user);
    Hamza_bot.fromMe = Hamza_bot.isAstro
      ? true
      : areJidsSameUser(Hamza_bot.user, _0x33935f);
    if (Hamza_bot.action === "remove" && Hamza_bot.fromMe) {
      return;
    }
    Hamza_bot.HamzaBot = [...Astro]
    ...
    ].includes(Hamza_bot.chat);
    Hamza_bot.isGroup = Hamza_bot.chat.endsWith("@g.us");
    if (Hamza_bot.isGroup) {
      Hamza_bot.metadata = await Hamza_grop.groupMetadata(Hamza_bot.chat);
      gcs[Hamza_bot.chat] = Hamza_bot.metadata;
      Hamza_bot.admins = Hamza_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      Hamza_bot.isAdmin = !!Hamza_bot.admins.find(
        (_0x859f83) => _0x859f83.id === Hamza_bot.user
      );
      Hamza_bot.isBotAdmin = !!Hamza_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    Hamza_bot.kick = Hamza_bot.remove = (_0x48f5af = Hamza_bot.user) =>
      Hamza_grop.groupParticipantsUpdate(Hamza_bot.chat, [_0x48f5af], "remove");
    Hamza_bot.add = (_0x422af3 = Hamza_bot.user) =>
      Hamza_grop.groupParticipantsUpdate(Hamza_bot.chat, [_0x422af3], "add");
    Hamza_bot.promote = (_0x3d0644 = Hamza_bot.user) =>
      Hamza_grop.groupParticipantsUpdate(Hamza_bot.chat, [_0x3d0644], "promote");
    Hamza_bot.demote = (_0x37d435 = Hamza_bot.user) =>
      Hamza_grop.groupParticipantsUpdate(Hamza_bot.chat, [_0x37d435], "demote");
    Hamza_bot.getpp = async (_0x577c8f = Hamza_bot.user) => {
      try {
        return await Hamza_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    Hamza_bot.sendMessage = async (
      _0x5a0f4b = Hamza_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await Hamza_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    Hamza_bot.sendUi = async (
      _0x107cb3 = Hamza_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
      ...
      return await Hamza_grop.sendUi(
        _0x107cb3,
        _0x15a4e0,
        _0x1e19fa,
        _0x3b7229,
    ...
    Hamza_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        Hamza_bot.chat !== Hamza_bot.botNumber
      ) {
        await Hamza_grop.sendMessage(Hamza_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await Hamza_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [Hamza_bot.user],
          },
          {
    ...
    Hamza_bot.send = async (
      ...
      _0xb61629 = "Hamza",
      _0x919f26 = "",
      _0x3ccfb1 = Hamza_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : Hamza_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await Hamza_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "pool":
          {
            return await Hamza_grop.sendMessage(
              ...
              {
                quoted: _0x919f26,
                messageId: Hamza_grop.messageId(),
              }
            );
          }
          break;
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await Hamza_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await Hamza_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await Hamza_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    Hamza_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = Hamza_bot.jid
    ) => {
      return await Hamza_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    Hamza_bot.checkBot = (_0x31c33b = Hamza_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    Hamza_bot.botNumber = _0x33935f;
    Hamza_bot.bot = _0x56741f ? Hamza_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return Hamza_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("HamzaMD");
